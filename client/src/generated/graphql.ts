...
export type GetJobQuery = { job?: { id: string, date: string, title: string, description?: string | null, company: { id: string, name: string } } | null };
...
export type JobsQuery = { jobs?: { totalCount: number, items?: Array<{ id: string, date: string, title: string, description?: string | null, company: { id: string, name: string } }> | null } | null };
